class ConfigModel {
  ...
  bool? get gamePointStatus => _gamePointStatus;
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    try {
      _decimalPointSettings = int.parse(
    ...
    _loyaltyPointItemPurchasePoint = double.tryParse(
      '${json['loyalty_point_item_purchase_point']}',
    );
    _loyaltyPointMinimumPoint = double.tryParse(
      '${json['loyalty_point_minimum_point']}',
    );
    _loyaltyPointExchangeRate = double.tryParse(
    ...
    _customerVerification = CustomerVerification.fromJson(
      json['customer_verification'],
    );
    ...
    _freeDeliveryOverAmount = double.tryParse(
      '${json['free_delivery_over_amount']}',
    );
    _maxOrderForCODAmount = double.tryParse(
      '${json['maximum_amount_for_cod_order']}',
    );
    _maxAmountCodStatus = '${json['maximum_amount_for_cod_order_status']}'
        .contains('1');
    _freeDeliveryStatus = '${json['free_delivery_over_amount_status']}'
        .contains('1');
    ...
    _returnPolicy = json['return_policy'] != null
        ...
        : null;
    _telegram = json['telegram'] != null
        ? Telegram.fromJson(json['telegram'])
        : null;
    ...
    _mostReviewedProductStatus = '${json['most_reviewed_product_status']}'
        .contains('1');
    _recommendedProductStatus = '${json['recommended_product_status']}'
        .contains('1');
    _flashDealProductStatus = '${json['flash_deal_product_status']}'.contains(
      '1',
    );
    _cancellationPolicyStatus = '${json['cancellation_policy_status']}'
        .contains('1');
    ...
    _isFirebaseOTPVerification = '${json['firebase_otp_verification_status']}'
        .contains('1');
    _orderImageStatus = '${json['order_image_status']}'.contains('1');
    _orderImageLabelName = json['order_image_label_name'];
    _maxImageUploadSize = int.tryParse(
      json['max_image_upload_size'].toString(),
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_ecommerceLocationCoverage != null) {
      data['ecommerce_location_coverage'] = _ecommerceLocationCoverage!
          .toJson();
    }
...
class ForgetPassword {
  ...
  ForgetPassword({this.firebase, this.phone, this.email});

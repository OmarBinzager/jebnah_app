...
import '../../../features/category/domain/models/category_product_model.dart';
...
class CategoryProvider extends ChangeNotifier {
  ...
  void sortCategoryProduct(int filterIndex) {
    if (filterIndex == 0) {
      _subCategoryProductList?.products?.sort(
      ...
      _subCategoryProductList?.products?.sort(
        (product1, product2) => product1.name!.toLowerCase().compareTo(

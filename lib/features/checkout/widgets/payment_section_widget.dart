                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextButton(
                      ...
                      child: Text(
                        getTranslated(showPayment ? 'change' : 'add', context),
                        style: poppinsBold.copyWith(
        ...
        if (checkoutProvider.partialAmount != null) ...[
          rowTextWidget(
            ...
            subTitle: PriceConverterHelper.convertPrice(
              context,
              checkoutProvider.partialAmount,
            ),
            context: context,
          ),
          const SizedBox(height: Dimensions.paddingSizeExtraSmall),
          rowTextWidget(
            title:
                "${checkoutProvider.selectedOfflineMethod != null ? "${getTranslated('paid_by', context)} ${checkoutProvider.selectedOfflineMethod?.methodName}" : checkoutProvider.selectedPaymentMethod?.getWayTitle ?? ''} (${getTranslated('due', context)})",
            subTitle: PriceConverterHelper.convertPrice(context, paidAmount),
            context: context,
          ),
        ],

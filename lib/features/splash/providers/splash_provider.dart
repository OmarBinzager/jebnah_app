...
import '../../../features/menu/domain/models/main_screen_model.dart';
...
import '../../wallet_and_loyalty/screens/game_screen.dart';
...
class SplashProvider extends ChangeNotifier {
  ...
  void initializeScreenList() {
    _screenList = [
      ...
      MainScreenModel(const GameScreen(), 'game_point', Images.game, true),
    ];
  }
}

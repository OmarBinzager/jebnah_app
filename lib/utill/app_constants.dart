import '../common/enums/local_caches_type_enum.dart';
import '../common/models/language_model.dart';
import '../common/enums/app_mode_enum.dart';
import 'images.dart';

class AppConstants {
  static const String appName = 'Jebnah';
  ...
  static const String featuredBrandUri = '/api/v1/brands/featured';
  static const String brandDetailsUri = '/api/v1/brands/details';
  static const String brandProductsUri = '/api/v1/brands/products';

  // Seller constants
  static const String sellerUri = '/api/v1/sellers';
  static const String featuredSellerUri = '/api/v1/sellers/featured';
  static const String sellerDetailsUri = '/api/v1/sellers/';
  static const String sellerProductsUri = '/api/v1/sellers/';
  ...
  static const String topic = 'Jebnah';
